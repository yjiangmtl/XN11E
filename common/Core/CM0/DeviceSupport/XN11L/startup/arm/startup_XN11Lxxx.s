;/*****************************************************************************
; * @file:    startup_XN11Lxxx.s
; * @description: CMSIS Cortex-M0 Core Device Startup File 
; *           for the Xinova XN11L Device Series 
; * @version: V1.0
; * @date:    4. Apr. 2014
; *-----------------------------------------------------------------------------
;
...
__Vectors       DCD     __initial_sp              ; Top of Stack
               ...
               DCD       TIMER16_0_IRQHandler               ; 16+3, 16-bit Timer0 Interrupt Handler 
               DCD       TIMER16_1_IRQHandler               ; 16+4, 16-bit Timer1 Interrupt Handler
               DCD       TIMER16_2_IRQHandler               ; 16+5,  16-bit Timer2 Interrupt Handler
               DCD       TIMER16_3_IRQHandler               ; 16+6,  16-bit Timer3 Interrupt Handler
               ...
               DCD       PWM_TIMER_IRQHandler                ; 16+17, PWM Timer Interrupt Handler     
...
Default_Handler PROC
                ...
                EXPORT  TIMER16_2_IRQHandler      [WEAK]
                EXPORT  TIMER16_3_IRQHandler      [WEAK]
                ...
                EXPORT  PWM_TIMER_IRQHandler            [WEAK]

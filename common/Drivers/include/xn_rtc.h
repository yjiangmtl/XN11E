/*****************************************************************************
 *   xn_rtc.h:  Header file for Xinnova XN11 Family Microprocessors
 *
...
#define XN_RTC             ((XN_RTC_TypeDef   *) RTC_BASE )
...
//MACRO
#define RTC_EnableTimerCounter (XN_RTC->CR.bit.RTCSTART=1)

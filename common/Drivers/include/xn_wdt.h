...
struct WDT_MOD_BITS {									// bit description
...
union WDT_MOD_REG {
				uint32_t				all;
				struct WDT_MOD_BITS	bit;
};
struct WDT_TC_BITS {									// bit description
...
union WDT_TC_REG {
				uint32_t				all;
				struct WDT_TC_BITS	bit;
};
struct WDT_FEED_BITS {									// bit description
...
union WDT_FEED_REG {
				uint32_t				all;
				struct WDT_FEED_BITS	bit;
};
struct WDT_TV_BITS {									// bit description
...
union WDT_TV_REG {
				uint32_t				all;
				struct WDT_TV_BITS	bit;
};
struct WDT_WARNINT_BITS {									// bit description
...
union WDT_WARNINT_REG {
				uint32_t				all;
				struct WDT_WARNINT_BITS	bit;
};
struct WDT_WINDOW_BITS {									// bit description
...
#define XN_WDT                             ((XN_WDT_TypeDef                *) WDT_BASE)

#define WDT_Enable_Timer (XN_WDT->MOD.bit.WDEN=1)
#define WDT_Disable_Timer (XN_WDT->MOD.bit.WDEN=0)

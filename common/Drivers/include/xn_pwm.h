/*****************************************************************************
 *   xn_pwm.h:  Header file for Xinnova XN62 Family Microprocessors
 *
...
#define XN_PWM	((XN_PWM_TypeDef	 *) PWM_BASE)
...
#define SelectPWMTriggerFreq(freq) (XN_PWM->CTRL.bit.TSCNT=freq)
#define SelectPWMTriggerMode(mode) (XN_PWM->CTRL.bit.TSSEL=mode)
#define EnablePWM0Trigger (XN_PWM->CTRL.bit.CH0OUTEN=1)
#define DisablePWM0Trigger (XN_PWM->CTRL.bit.CH0OUTEN=0)
#define EnablePWM1Trigger (XN_PWM->CTRL.bit.CH1OUTEN=1)
#define DisablePWM1Trigger (XN_PWM->CTRL.bit.CH1OUTEN=0)
#define EnablePWM2Trigger (XN_PWM->CTRL.bit.CH2OUTEN=1)
#define DisablePWM2Trigger (XN_PWM->CTRL.bit.CH2OUTEN=0)
#define EnablePWM3Trigger (XN_PWM->CTRL.bit.CH3OUTEN=1)
#define DisablePWM3Trigger (XN_PWM->CTRL.bit.CH3OUTEN=0)
#define EnablePWM4Trigger (XN_PWM->CTRL.bit.CH4OUTEN=1)
#define DisablePWM4Trigger (XN_PWM->CTRL.bit.CH4OUTEN=0)
#define EnablePWM5Trigger (XN_PWM->CTRL.bit.CH5OUTEN=1)
#define DisablePWM5Trigger (XN_PWM->CTRL.bit.CH5OUTEN=0)
